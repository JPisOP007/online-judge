...
class SubmitSolutionForm(forms.Form):
    ...
    # Make problem_id optional and handle it in the view
...
class ProblemForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        # Save test cases JSON to the correct field
...
class ContestForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        # Auto-calculate duration if not provided but start and end times are
        ...
        # If duration is provided but end_time is not, calculate end_time
